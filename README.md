...
### Files
[amazon_modeling_final.ipynb](/Users/jbpatty/project-4/amazon_modeling_final.ipynb) shows the use of CountVectorizer and TF-IDF for NMF topic modeling to break down and analyze Amazon reviews for Grocery and Gourmet Foods.

[amazon_data_cleaning](/Users/jbpatty/project-4/amazon_modeling_final.ipynb) shows the process of cleaning a million rows of Amazon Grocery and Gourment product data, preparing it for modeling, and building a classification model using the review analysis data
